...
public class Controller {
	...
	protected ResponseEntity<Map<String, Object>> patch(String id, Map<String, Object> patchRequest, HttpServletRequest request, HttpServletResponse response, SchemaResourceType resourceType, String attributes, String excludedAttributes) {
		...
		try {
			...
			ResponseEntity<Map<String, Object>> ret = patch(id, patchRequest, mainSchema, location, existingEntity);
	...
	protected ResponseEntity<Map<String, Object>> patch(String id, Map<String, Object> patchRequest, Schema mainSchema, String location, Map<String, Object> existingEntity) throws ConstraintViolationException {
	...
	private void includeGroups(String id, Map<String, Object> object ) {
		...
		for( Map m : groupSearch ) {
			copyMap = new HashMap();
			copyMap.put("value", m.get("id"));
			copyMap.put("display", m.get("displayName"));
			copyMap.put("$ref", ((Map)m.get("meta")).get("location"));
			copyMap.put("type", ((Map)m.get("meta")).get("resourceType"));
			filteredGroups.add(filterAttributes(groupsSchema, copyMap, null, null));
		}
